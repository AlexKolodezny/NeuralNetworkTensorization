...
class TuckerConvModel(nn.Module):
    def __init__(self):
        super(TuckerConvModel, self).__init__()
        self.conv = nn.Sequential(
            ...
            nn.Sequential(
                TuckerConv((8, 8), (8, 8), (3, 3), args.tucker_channel_rank, args.tucker_space_rank, padding="same"),
                nn.BatchNorm2d(64),
                nn.ReLU(),
            ),
            nn.MaxPool2d((3, 3), stride=(2, 2), padding=(1, 1)),
            nn.Sequential(
                TuckerConv((8, 8), (16, 8), (3, 3), args.tucker_channel_rank, args.tucker_space_rank, padding="same"),
                nn.BatchNorm2d(128),
                nn.ReLU(),
            ),
            nn.Sequential(
                TuckerConv((16, 8), (16, 8), (3, 3), args.tucker_channel_rank, args.tucker_space_rank, padding="same"),
                nn.BatchNorm2d(128),
                nn.ReLU(),
            ),
            nn.MaxPool2d((3, 3), stride=(2, 2), padding=(1, 1)),
        ...
        # self.ttrl = TTTF(((16, 8), (8,), (8,)), (args.tttf_channel_rank, (args.tttf_space_rank,), (args.tttf_space_rank,)), (10,), (10,))
