...
python3 ResNet-Greedy-TN-TRL-tensorized-full.py --tensorization $tensorization --seed $seed --device $device --full_train $full_train --edge_train $edge_train --slice_gain $gain | tee ./logs/greedy_tn_trl_tensorized_full.$seed.log
COUNTER=0
