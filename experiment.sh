...
python3 ResNet-Greedy-TN.py --network $network --classifier $classifier --tensorization $tensorization --seed $seed --device $device --full_train $full_train --edge_train $edge_train --slice_gain $gain $pretrained_filename | tee ./logs/greedy_tn.$seed.log
COUNTER=0
