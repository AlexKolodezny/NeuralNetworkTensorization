...
from src.greedy_tn import choose_and_increase_edge, random_choose_and_increase_edge
...
for i in range(20):
    ...
    for core in get_layer(model).construct_network():
        print(core.name, core.shape)
    random_choose_and_increase_edge(model, "classifier", device, get_layer=get_layer, set_layer=set_layer)
